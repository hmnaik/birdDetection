...
print('Label File : ', PATH_TO_LABELS)
print('CKPT File : ', PATH_TO_CKPT)
...
PATH_TO_SAVE_TEST_IMAGES_DIR = '/media/hemal/37960676-e41c-4a31-ab6a-e01a2521f68b/hemal/BirdDataset/testResults'
...
while (cap.isOpened()):
    ...
    testImage = Image.fromarray(frame)
    testImage.save(save_image_as)

    # cv2.imshow('testWindow',testImage)
    # outputVideo.write(testImage)
